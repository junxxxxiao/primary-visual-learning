...
generate_narration confirm-text 166 '好，我看到你输入的问题了。你想知道的是：更用力拨同一根弦，音调会更高吗？这个问题很有意思！我们先别急着找答案，先把“响”和“高”分清楚。'
generate_narration confirm-photo 164 '我看到你拍下的是一根琴弦。你想问的是：更用力拨同一根弦，音调会更高吗？图片和问题都确认好了。接下来，我们先把“响”和“高”分清楚。'
generate_narration confirm-voice 166 '好，我听清楚了。你想知道的是：更用力拨同一根弦，音调会更高吗？这个问题很有意思！我们先别急着找答案，先把“响”和“高”分清楚。'
generate_narration calibration 164 '开始猜之前，我们先把两个很容易混在一起的词分清楚：响度，是听起来有多响；音调，是听起来有多高。先听第一组响度，再听第二组音调。用耳朵找找它们的不同吧。'
generate_narration lesson-intro 164 '现在，我们正式来解决这个问题：更用力拨同一根弦，音调会更高吗？我会先用三小段画面，一步一步讲清楚。讲解时只需要看和听，等讲完了，再轮到你亲手拨琴弦验证。'
generate_narration prediction 166 '好，先凭感觉猜一猜。会更高、基本不变，还是你还不确定？放心，猜错也没关系，等一会儿，我们用同一根琴弦亲自验证。'
